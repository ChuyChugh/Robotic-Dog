...
void loop() {
    ...
    if(character == 'u'){
      float pos_m0 = Axis::set_axis0(0,400);
      float pos_m1 = Axis::set_axis1(0,400);
      odrive1.SetPosition(0,pos_m0, 10);
      odrive1.SetPosition(1,pos_m1, 10);
    }
    if(character = 'd'){
      float pos_m0 = Axis::set_axis0(0,0);
      float pos_m1 = Axis::set_axis1(0,0);
      odrive1.SetPosition(0,pos_m0, 10);
      odrive1.SetPosition(1,pos_m1, 10);
    }
  }
